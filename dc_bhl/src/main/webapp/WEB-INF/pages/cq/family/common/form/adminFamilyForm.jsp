...
<fieldset>
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td class="fieldValue">
                <tags:dataDictRadio dataDict="是否" name="isValid" value="${family.isValid}"/>
            </td>
...
<fieldset>
    ...
    <table class="table table-bordered" id="personTable1">
        <tr>
            <td class="fieldName" style="text-align: center;" colspan="9">户籍在本址</td>
        </tr>
        <tr>
        ...
        <c:forEach begin="0" end="${4+fn:length(familyPersonList1)}" var="i">
            ...
            <tr>
                ...
                <td style="text-align: center;"><input type="text" class="form-control" name="fp_hzRelation" value="${familyPerson1.hzRelation}"/></td>
    ...
    <table class="table table-bordered" id="personTable2">
        ...
        <c:forEach begin="0" end="${4+fn:length(familyPersonList2)}" var="i">
            ...
            <tr>
                ...
                <td style="text-align: center;"><input type="text" class="form-control" name="fp_relation" value="${familyPerson2.relation}"/></td>
...
<fieldset>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="fieldValue" style="width: 10%;"><input class="form-control digits" type="text" name="dabNum" size="5" value="${family.dabNum}"/></td>
            <td class="fieldName" style="width: 10%;">低收入家庭救助(证)</td>
            <td class="fieldValue" style="width: 10%;"><input class="form-control digits" type="text" name="lowNum" size="5" value="${family.lowNum}"/></td>
            <td class="fieldName" style="width: 10%;">现役军人(人)</td>
            <td class="fieldValue" style="width: 10%;"><input class="form-control digits" type="text" name="armyNum" size="5" value="${family.armyNum}"/></td>
        </tr>
        </tbody>
    </table>
</fieldset>
