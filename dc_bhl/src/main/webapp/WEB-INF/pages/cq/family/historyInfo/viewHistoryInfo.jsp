        ...
        <fieldset>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="fieldValue">
                        ${family.helpNum}
                        <c:if test="${family.helpNum ne preFamily.helpNum}">
                            <span class="require">原数据：${preFamily.helpNum}</span>
                        </c:if>
                    </td>
                    <td class="fieldName">教师资格数</td>
                    <td class="fieldValue">
                        ${family.teacherNum}
                        <c:if test="${family.teacherNum ne preFamily.teacherNum}">
                            <span class="require">原数据：${preFamily.teacherNum}</span>
                        </c:if>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="fieldValue">
                        ${family.glNum}
                        <c:if test="${family.glNum ne preFamily.glNum}">
                            <span class="require">原数据：${preFamily.glNum}</span>
                        </c:if>
                    </td>
