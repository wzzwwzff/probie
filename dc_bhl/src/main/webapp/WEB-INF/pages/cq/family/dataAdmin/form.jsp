...
<form id="rhForm" class="form-inline" method="post">
    <input type="hidden" name="familyId" id="familyId" value="${family.id}"/>
    <div class="content">
        <%@include file="main.jsp"%>
        <%@include file="/WEB-INF/pages/cq/family/common/form/adminFamilyForm.jsp"%>
    </div><br/><br/><br/>
    <div class="footer resizeLayout">
        <button class="btn btn-primary btn-sm" type="button" onclick="javascript:familySave()"><i class="fa fa-save"></i>&nbsp;保存</button>
        &nbsp;&nbsp;
