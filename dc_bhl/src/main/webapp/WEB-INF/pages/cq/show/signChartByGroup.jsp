...
<div class="container-fluid">
    <div class="row" style="margin-top: 50px;">
        <div class="col-lg-12 text-center" style="font-size: 45px;font-weight: bold;margin-bottom: 10px;">东城区宝华里危改项目签约情况分组公示</div>
    </div>
    <div class="row">
...
<script>
    ...
    function getData(){
        $.get("dataTable2",{type:'qy',bdCode:${bdCode},myTime:new Date().getTime()},function(data){
            $("#data").html(data);
        })
