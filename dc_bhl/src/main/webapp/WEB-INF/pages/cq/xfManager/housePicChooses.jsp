    ...
    <div class="modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document" style="width: 900px;">
            ...
            <div class="modal-content">
                ...
                <input name="houseId" type="hidden" id="houseId" value="${house.id}">
                <div class="modal-body" id="myModalBoday">
                    加载中...
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary btn-sm" <c:if test="${house.houseStatus eq 2}">disabled</c:if> type="button" onclick="javascript:saveBuildStatus()"><i
                            class="fa fa-save"></i>&nbsp;确认修改
                    </button>
