    ...
    <div class="search form-inline">
            ...
            <div class="search_content">
                <form id="search" class="form-search">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                            <div class="input-group-addon">财务结算状态</div>
                            <tags:searchDataDict name="f.settleStatus" fieldType="integer" dataDict="结算状态" className="form-control"/>
                        </div>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <th class="text-center">财务结算状态</th>
            ...
            <c:forEach items="${pageInfo.result}" var="family" varStatus="status">
                <tr>
                    ...
                    <td class="text-center"><tags:dataDict dataDict="结算状态" value="${family.settleStatus}"/></td>
                    <td class="text-center">
                        <a href="/cq/family/common/view/main?familyId=${family.id}"><i class="fa fa-big fa-eye"></i>&nbsp;查看</a>&nbsp;&nbsp;
                        <c:if test="${family.settleStatus eq 1}">
                            <a href="javascript:settle('${family.id}')"
                               title="结算放款"><i class="fa fa-print"></i>&nbsp;结算放款
                            </a>
                        </c:if>
                    </td>
                </tr>
...
<script>
    ...
    function settle(familyId) {
        if (confirm("确定要将该家庭设置为已放款状态吗？")) {
            $.get("settle", {familyId: familyId, _date: new Date().getTime()}, function (data) {
