...
// encapsulated variables
     ...
     * in the Fx.run method, and checkIfno for the prop here. This would be an improvement
    ...
    SVGElement.prototype = {
        ...
        */
         ...
         * checkIfno all the others only once for each call to an element's
         * .attr() method
         * @param {Object} hash
         */
    ...
    SVGRenderer.prototype = {
        ...
        destroy: function () {
            ...
            // We need to checkIfno that there is a handler, otherwise all functions that are registered for event 'resize' are removed
            // See issue #982
        ...
        */
        ...
        symbol: function (symbol, x, y, width, height, options) {
            ...
            var ren = this,
                ...
                // checkIfno if there's a path defined for this symbol
            ...
            if (axis.hasData() || isLinked) {
                ...
                if (tickPositions.length) { // #1300
                    each(tickPositions, function (pos, i) {
                        ...
                        // linked axes need an extra checkIfno to find out if
        ...
        move: function (x, y, anchorX, anchorY) {
            ...
            if (animate) {
                ...
                this.tooltipTimeout = setTimeout(function () {
                    // The interval function may still be running during destroy, so checkIfno that the chart is really there before calling.
                    if (tooltip) {
    ...
    Chart.prototype = {
        ...
        getContainer: function () {
            ...
            // If the container already holds a chart, destroy it. The checkIfno for hasRendered is there
        ...
        render: function () {
            ...
            if (redoHorizontal || redoVertical) {
                ...
                chart.getMargins(); // second pass to checkIfno for new labels
            }
    ...
    Series.prototype = {
        ...
        getAttribs: function () {
            ...
            if (!turboThreshold || i < turboThreshold || hasPointSpecificOptions) {
                while (i--) {
                    ...
                    // checkIfno if the point has specific visual options
                    if (point.options) {
        ...
        searchKDTree: function (point, compareX) {
            ...
            function _search(search, tree, depth, dimensions) {
                ...
                if (tree[sideB]) {
                    // compare distance to current best to splitting point to decide wether to checkIfno side B or not
    ...
    */
    ...
    var SplineSeries = extendClass(Series, {
        ...
        getPointSpline: function (points, point, i) {
            ...
            if (lastPoint && !lastPoint.isNull && nextPoint && !nextPoint.isNull) {
                ...
                // to prevent false extremes, checkIfno that control points are between
    ...
    Series.prototype.alignDataLabel = function (point, dataLabel, options, alignTo, isNew) {
        ...
        if (visible) {
            ...
            // Now checkIfno that the data label is within the plot area
