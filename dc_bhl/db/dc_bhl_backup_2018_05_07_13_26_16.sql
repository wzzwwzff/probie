...
--
-- Host: 127.0.0.1    Database: dc_bhl
-- ------------------------------------------------------
...
INSERT INTO `datadict` VALUES (83,NULL,'系统配置','系统配置',999,1,NULL),(830,'','系统名称','东城区宝华里危改项目签约、选房系统',0,1,83),(831,'','系统版本','1.0',0,1,83),(832,'','技术支持','北京佳木东方科技有限公司',0,1,83),(833,'','数据库下载路径','D:\\mySQL_Backup\\dc_bhl',0,1,83),(834,NULL,'是否有效','是否有效',999,1,NULL),(835,'green','有效','1',10,1,834),(836,'red','无效','2',20,1,834);
...
INSERT INTO `sqlexecuteinfo` VALUES (1,'SELECT * FROM userinfo','111');
...
INSERT INTO `userinfo` VALUES (1,1,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,'2018-05-07 13:22:18',NULL,'jmdf2018','','管理员',NULL,NULL,'',0,'admin',1);
...
--
-- Dumping events for database 'dc_bhl'
--

--
-- Dumping routines for database 'dc_bhl'
--
...
-- Dump completed on 2018-05-07 13:26:17
