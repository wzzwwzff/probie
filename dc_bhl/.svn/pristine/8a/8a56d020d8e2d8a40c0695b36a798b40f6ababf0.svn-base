    ...
    <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        ...
        <c:forEach items="${theads}" var="item" varStatus="status">
            ...
            <c:if test="${item eq '家庭成员'}">
                ...
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>是否在本址</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>户口本数</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>姓名</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>身份证号</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>与户主关系/与被拆迁人关系</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>户主与被拆迁人关系</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>户口所在地</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>是否享受过保障性住房政策</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>是否享受人均5㎡</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>是否长期住在未登记房屋内</td>
            ...
            <c:if test="${fpSize ge houseSize}">
                <c:forEach var="familyPerson" items="${familyPersonList}" varStatus="fpStatus">
                    ...
                    <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
                        ...
                        <td class="xl69"><tags:dataDict dataDict="是否" value="${familyPerson.type}"/></td>
                        <td class="xl69">${familyPerson.hkNum}</td>
                        <td class="xl69">${familyPerson.name}</td>
                        <td class="xl69">${familyPerson.idCard}</td>
                        <td class="xl69">${familyPerson.relation}</td>
                        <td class="xl69">${familyPerson.hzRelation}</td>
                        <td class="xl69">${familyPerson.hjAddress}</td>
                        <td class="xl69"><tags:dataDict dataDict="是否" value="${familyPerson.status}"/></td>
                        <td class="xl69"><tags:dataDict dataDict="是否" value="${familyPerson.aveStatus}"/></td>
                        <td class="xl69"><tags:dataDict dataDict="是否" value="${familyPerson.flag}"/></td>
