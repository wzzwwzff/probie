        ...
        <fieldset>
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <td class="fieldValue"><input type="text" class="form-control datetimePicker dateISO" style="width: 150px;height: 36px;background-image:url(/static/plugin/datepicker/img/icon.png); background-repeat:no-repeat; background-position:right center;" name="jfDate" value="<fmt:formatDate value="${family.jfDate}" pattern="yyyy-MM-dd" />"/></td>
                </tr>
                <tr>
                    <td class="fieldName">交房操作人</td>
                    <td class="fieldValue" colspan="3"><input type="text" class="form-control" name="jfPerson" size="24" value="${family.jfPerson}"/></td>
                </tr>
                <tr>
                    <td class="fieldName">交房备注</td>
                    <td class="fieldValue" colspan="3">
                        <textarea class="form-control" type="text" name="jfMemo" cols="60" rows="4">${family.jfMemo}</textarea>
                    </td>
                </tr>
            </table>
        </fieldset>
