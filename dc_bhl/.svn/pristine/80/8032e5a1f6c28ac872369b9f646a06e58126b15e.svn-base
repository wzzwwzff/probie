    ...
    <div class="search form-inline" >
            ...
            <div class="search_content">
                <form id="search" class="form-search">
                    <div class="form-group">
                        ...
                        <a href="javascript:checkBoxTrue();" class="btn btn-primary btn-sm"><i class="fa fa-search" aria-hidden="true"></i> 批量初审通过</a>
                    </div>
                </form>
            </div>
        </div>
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <th class="text-center">拆迁数据锁定状态</th>
                <th class="text-center">评估数据锁定状态</th>
                <th class="text-center">测绘数据锁定状态</th>
...
<script>
    ...
    function checkBoxTrue() {
        if(confirm("确定被选中的家庭全部初审通过么？(注：三项必须全部锁定的家庭才会通过!)")) {
            var a = new Array();
            $(".checkItem").each(function (key, val) {
            ...
            location.href = "checkBoxTrue?idItems=" + a;
        }
    }
</script>