...
public class RedirectAttributesExcel {
     ...
     * @param dataList           显示内容
     */
    public static void addFlashAttribute(RedirectAttributes redirectAttributes, String fileName, String title, String[] theads, List dataList,String familyPerson,String houseInfo) {
        ...
        redirectAttributes.addFlashAttribute("houseInfo", houseInfo);
    }
}
