...
public class HttpClientUtil {
    ...
    public static CloseableHttpResponse getResponse(HttpRequestBase request) throws IOException {
        ...
        request.setHeader("User-Agent", "Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16A5339e MicroMessenger/6.7.1 NetType/WIFI Language/zh_CN");
