                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="fieldValue"><input type="text" name="name" value="${family.name}" size="10" placeholder="必填项"
                                                          class="form-control required"  placeholder="必填项" style="width: 10em"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fieldValue"><input size="10" type="text" name="jsPerson" class="form-control number" value="${family.jsPerson}" style="width: 10em"/></td>
                ...
                <fieldset>
                    ...
                    <table class="table table-bordered" id="personTable" style="margin-top: -5px;">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 3%">年龄</th>
                            <th class="text-center" style="width: 4%">性别</th>
                            <th class="text-center" style="width: 8%">证件号码</th>
                            <th class="text-center" style="width: 6%">联系电话</th>
                            <th class="text-center" style="width: 5%">关系</th>
                            <th class="text-center" style="width: 10%">生活状态</th>
                            <th class="text-center" style="width: 10%">户口所在地</th>
                            <th class="text-center" style="width: 5%">在册/非在册</th>
                            <th class="text-center" style="width: 12%">备注</th>
                        ...
                        <c:forEach begin="0" end="${fn:length(familyPersonList)}" var="i" varStatus="status">
                            <tr>
                                ...
                                <td align="center">
                                    <input type="text" name="pLiveStatus" value="${familyPersonList[i].pLiveStatus}" class="form-control">
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    <textarea class="form-control" name="pMemo" cols="60" rows="4" style="resize:none">${familyPersonList[i].pMemo}</textarea>
                                </td>
                                <td align="center">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td class="fieldValue" colspan="3"><input type="text" name="azHouse" value="${family.azHouse}" class="form-control number" style="width: 15em"/></td>
                            </tr>
                            <tr>
                                ...
                                <td class="fieldValue" colspan="3" style="height: 15em;">
                                    <table>
                                        <tr>
                                            <td>一居室</td><td><input type="text" name="oneRoomCount" value="${family.oneRoomCount}" id="oneRoomCount" class="form-control number xfCount" style="width: 5em"/></td><td>(㎡/套)<span style="color: red">剩余xx套</span></td>
                                        </tr>
                                        <tr>
                                            <td>二居室</td><td><input type="text" name="firstTwoRoomCount" value="${family.firstTwoRoomCount}" id="firstTwoRoomCount" class="form-control number xfCount" style="width: 5em"/></td><td>(㎡/套)<span style="color: red">剩余xx套,</span></td>
                                            <td>二居室</td><td><input type="text" name="secondTwoRoomCount" value="${family.secondTwoRoomCount}" id="secondTwoRoomCount" class="form-control number xfCount" style="width: 5em"/></td><td>(㎡/套)<span style="color: red">剩余xx套,</span></td>
                                            <td>二居室</td><td><input type="text" name="thirdTwoRoomCount" value="${family.thirdTwoRoomCount}" id="thirdTwoRoomCount" class="form-control number xfCount" style="width: 5em"/></td><td>(㎡/套)<span style="color: red">剩余xx套,</span></td>
                                            <td>二居室</td><td><input type="text" name="fourthTwoRoomCount" value="${family.fourthTwoRoomCount}" id="fourthTwoRoomCount" class="form-control number xfCount" style="width: 5em"/></td><td>(㎡/套)<span style="color: red">剩余xx套</span></td>
                                        </tr>
                                        <tr>
                                            <td>三居室</td><td><input type="text" name="threeRoomCount" value="${family.threeRoomCount}" id="threeRoomCount" class="form-control number xfCount" style="width: 5em"/></td><td>(㎡/套)<span style="color: red">剩余xx套</span></td>
                                        </tr>
                                        <tr>
                                            <td>实际选房套数</td><td><input type="text" name="xfTotalCount" value="${family.xfTotalCount}" readonly id="xfTotalCount" class="form-control number" style="width: 5em"/></td><td>(套)</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="fieldValue"><input type="text" name="selectedArea" value="${family.selectedArea}" readonly class="form-control number" style="width: 10em;float: left"/><div style="float: left;margin-top: 5px;font-size: 15px">㎡</div></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="fieldValue"><input type="text" name="inMoney" readonly value="${family.inMoney}" class="form-control number" style="width: 10em;float: left"/><div style="float: left;margin-top: 5px;">元</div></td>
                                <td class="fieldName">指标外购房款：</td>
                                <td class="fieldValue"><input type="text" name="outMoney" readonly value="${family.outMoney}" class="form-control number" style="width: 10em;float: left"/><div style="float: left;margin-top: 5px;">元</div></td>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td class="fieldValue" colspan="3"><input type="text" name="totalMoney" readonly value="${family.totalMoney}" class="form-control number" style="width: 10em;float: left"/><div style="float: left;margin-top: 5px;">元</div></td>
                            </tr>
                            <tr>
                                <td class="fieldName">结算后款：</td>
                                <td class="fieldValue" colspan="3"><input type="text" name="settlementedMoney" readonly value="${family.settlementedMoney}" class="form-control number" style="width: 10em;float: left"/><div style="float: left;margin-top: 5px;">元</div></td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset>
