...
<div class="content">
    <div class="form-inline" id="hideCls" style="padding-bottom: 20px;">
        <ul class="nav nav-tabs">
            <li class="active"><a href="cwMain.html">批次电话通知管理</a></li>
            <li><a href="cwList.html">已上报批次</a></li>
        </ul>
    </div>
    <table class="table table-bordered" style="text-align: center;">
        <tr>
            <td style="width: 62%;font-size: 24px;font-weight: bold;">本批次电话通知家庭</td>
            <td style="font-size: 24px;font-weight: bold;">审核已通过还电话通知家庭</td>
        </tr>
        <tr>
            <td>
                <div id="chart1">
            ...
            <td>
                <div id="chart2">
                    <div class="search_content" style="text-align: left;">
                        <form class="form-inline" role="form">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon">审计审核日期</div>
                                    <input name="date" type="text" style="width: 130px;height: 33px;"
...
<div class="footer">
    <%--<form class="form-inline">--%>
        <%--<span style="font-weight: bold;font-size: 20px;">审计审核日期：</span>--%>
        <%--<input name="date" type="text" style="width: 130px;height: 33px;" class="form-control form-date-time dateISO">--%>
        <%--至--%>
        <%--<input name="date" type="text" style="width: 130px;height: 33px;" class="form-control form-date-time dateISO">--%>
        <%--<button type="button" class="btn btn-primary"><i class="fa fa-search"></i>&nbsp;提取家庭</button>　　　--%>
