...
public class Family {
    ...
    private Date signDate;              //	签约日期（原补偿 协议）
    ...
    private BigDecimal zxRepair;            //专项维修费
    private BigDecimal jsMoney;        //	结算款

    //根据房屋建筑面积计算购房款 2018.10.15
    private BigDecimal yxfArea;        //	已选房面积(预测面积计算)
    private BigDecimal inFifArea;        //	超15㎡内面积(预测面积计算)
    private BigDecimal outFifArea;        //	超15㎡外面积(预测面积计算)
    private BigDecimal bnHouseMoney;        //	超标内房款(4000／㎡）(预测面积计算)
    private BigDecimal bwHouseMoney;        //	超标外房款6000／㎡）(预测面积计算)
    private BigDecimal zHouseMoney;        //	总购房款(预测面积计算)
    ...
    public BigDecimal getZxRepair() {
        return zxRepair;
    }

    public void setZxRepair(BigDecimal zxRepair) {
        this.zxRepair = zxRepair;
    }
    ...
    public BigDecimal getzHouseMoney() {
        return zHouseMoney;
    }

    public void setzHouseMoney(BigDecimal zHouseMoney) {
        this.zHouseMoney = zHouseMoney;
    }
