...
<div class="content">
    ...
    <div class="search_content resizeLayout" style="margin-top: 5px;">
        <form class="form-inline" role="form" id="search">
            ...
            &nbsp;&nbsp;
            <%--<button type="button" class="btn btn-sm btn-primary" onclick="location.href='calcMethod'"><i class="fa fa-print"></i>&nbsp;预测面积计算</button>--%>
            <%--<button type="button" class="btn btn-sm btn-primary" onclick="location.href='scCalcMethod'"><i class="fa fa-print"></i>&nbsp;实测面积计算</button>--%>
            <%--<button type="button" class="btn btn-sm btn-primary" onclick="location.href='moveCalcMethod'"><i class="fa fa-print"></i>&nbsp;23日前平移计算</button>--%>
        </form>
    </div>
