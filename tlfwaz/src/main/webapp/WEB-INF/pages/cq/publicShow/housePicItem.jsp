...
<c:if test="${maxFloor ne 0}">
    <div style="text-align: right;margin-right: 3px">
        ...
        <button class="button btn button-circle"
                style="background-color: #0080FF;margin-bottom: 10px;width: 25px;height: 25px;"></button>
        <span style="color: #0080FF;font-size: 18px;">已换签</span>
    </div>
    <br/>
    <%
        if (max != 0) {
...
//                        }
            ...
            %>
            <td height="40" width="<%=width %>%" bgcolor="<%=bgColor%>" class='msg_tk'
