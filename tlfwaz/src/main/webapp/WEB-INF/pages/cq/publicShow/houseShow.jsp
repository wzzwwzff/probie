...
<script>
    ...
    var allCountNew = 0;
    function sendData() {
        $.get("getHouseCount", {_date: new Date().getTime()}, function (data) {
        ...
        $.get("houseShowTable", {pageNo: pageNo, pageSize: pageSize, _date: new Date().getTime()}, function (data) {
            $("#charMy").html(data);
        });
    }
    $(function () {
