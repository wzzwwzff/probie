...
<div class="form-group">
    ...
    <div class="input-group input-group-sm">
        ...
        <tags:searchInput name="f.idCard" fieldType="string" size="20" operator="like" className="form-control"/>
    </div>
    <div class="input-group input-group-sm">
        <div class="input-group-addon">房屋坐落</div>
        <tags:searchInput name="f.fwzl" fieldType="string" size="20" operator="like" className="form-control"/>
    </div>
</div>
