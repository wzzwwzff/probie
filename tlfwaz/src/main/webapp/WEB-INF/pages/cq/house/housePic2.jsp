...
<body>
<div class="title" style=" background: #f3f3f4;"><h4>房源销控查看</h4></div>
...
<script type="text/javascript">
    ...
    function addOrEdit(houseId) {//打开弹出层
        var nodes = zTree.getSelectedNodes();
        var projectId = nodes[0].id;//项目id
        $.get("houseMsg2",{houseId:houseId,projectId:projectId, _time: new Date().getTime()},function(data){
