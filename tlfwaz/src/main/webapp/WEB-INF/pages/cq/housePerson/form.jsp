...
<div class="title">
    ...
    <div style="float: right;">
        <button class="btn btn-white btn-sm" type="button" onclick="location.href='list?$<tags:searchParams></tags:searchParams>'"><i class="fa fa-backward"></i>&nbsp;返回列表</button>
    </div>
</div>
<div class="content">
        ...
        <fieldset>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th width="6%" class="text-center">变更产确认名字</th>
                    <th width="6%" class="text-center">审核</th>
                    <th width="6%" class="text-center">打印协议</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${houseList}" var="house">
                    <tr>
                        ...
                        <td>
                            <a href="printContracts?familyId=${family.id}&houseId=${house.id}"><i class="fa fa-print"></i>打印协议</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
