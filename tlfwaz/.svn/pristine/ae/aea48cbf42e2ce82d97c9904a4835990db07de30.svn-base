        ...
        function checkLogin() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.status == 9) {
                        location.href = "/cq/project/index";
    ...
    <div class="loginWrapbg">
        ...
        <div class="loginCt">
            <div style="text-align: center">
                <img src="/static/image/logo.jpg" style="width: 35px;margin-top: -10px">
                <span style="line-height:70px;font-size: 25px;padding-top:20px;margin-top: 15px;font-family:'微软雅黑','黑体' "><b><%=systemName %></b></span>
            </div>
            <div class="welcome"><span id="logining_info">请输入用户名、密码、验证码</span></div>
