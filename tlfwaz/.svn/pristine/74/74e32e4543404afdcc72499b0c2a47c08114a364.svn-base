        ...
        <fieldset>
            ...
            <table class="table table-bordered table-hover" id="personTable">
                <tr>
                    ...
                    <td class="fieldName" style="text-align: center;width: 10%">联系电话</td>
                    <td class="fieldName" style="text-align: center;width: 10%">与<span
                ...
                <c:forEach begin="0" end="${1+fn:length(familyPersonList)}" var="i" varStatus="status">
                    ...
                    <tr id="tr_${status.index+1}">
                        <input type="hidden" name="f_id" value="${familyPerson.id}"/></td>
                        <td style="text-align: center;">
                            <c:if test="${familyPerson.pName eq null}"><input type="text" id="f_pName${status.index+1}"
                                                                              name="f_pName" class="form-control"
                                                                              size="10"
                                                                              value="${familyPerson.pName}"/></c:if>
                            <c:if test="${familyPerson.pName ne null}">
                                <input type="text" id="f_pName${status.index+1}" name="f_pName" class="form-control"
                                       readonly size="10" value="${familyPerson.pName}"/>
                            </c:if>
                        </td>
                        <td style="text-align: center;">
                            <tags:dataDictInput name="f_pSex" dataDict="性别" className="form-control"
                                                value="${familyPerson.pSex}"/>
                        </td>
                        <td style="text-align: center;">
                            <input type="text" name="f_pIdCard" class="form-control" size="28"
                                   value="${familyPerson.pIdCard}"/>
                        </td>
                        <td style="text-align: center;">
                            <input type="text" name="f_pPhone" class="form-control"
                                   value="${familyPerson.pPhone}"/>
                        </td>
                        <td style="text-align: center;">
                            <input type="text" name="f_pRelation" class="form-control"
                                   value="${familyPerson.pRelation}"/>
                        </td>
                        <td style="text-align: center;">
                            <tags:dataDictInput name="f_isRegistered" dataDict="是否" className="form-control"
                                                value="${familyPerson.isRegistered}"/>
                        </td>
                        <td style="text-align: center;">
                            <tags:dataDictInput name="f_addressType" dataDict="户籍" className="form-control"
                                                value="${familyPerson.addressType}"/>
                        </td>
                        <td style="text-align: center;">
                            <input type="text" name="f_pAddress" class="form-control" value="${familyPerson.pAddress}"/>
                        </td>
                        <td style="text-align: center;">
                            <input type="text" name="f_pMemo" class="form-control" value="${familyPerson.pMemo}"/>
                        </td>
                    </tr>
                </c:forEach>
            </table>
