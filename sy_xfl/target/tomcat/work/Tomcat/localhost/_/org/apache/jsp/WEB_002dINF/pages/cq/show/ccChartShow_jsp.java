 ...
 * Generated at: 2018-08-03 07:21:39 UTC
...
public final class ccChartShow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <div class=\"col-lg-12 text-center\" style=\"font-size: 45px;font-weight: bold;margin-bottom: 10px;\">顺义区马坡镇西丰乐村棚户区改造土地开发项目拆除情况公示</div>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                            if (this.point.name == '已拆除') {\r\n");
      out.write("                                return \"<center>\" + \"已拆除:\" + this.y + \"户<br/>比例:\" + this.point.percentage.toFixed(2) + \"%</center>\";\r\n");
      out.write("                            }\r\n");
      out.write("                            if (this.point.name == '未拆除') {\r\n");
      out.write("                                return \"<center>\" + \"未拆除:\" + this.y + \"户<br/>比例:\" + this.point.percentage.toFixed(2) + \"%</center>\";\r\n");
      out.write("                            }\r\n");
      out.write("                        }\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                        color: '#000000',\r\n");
      out.write("                        formatter: function () {\r\n");
      out.write("                            if (this.series.name == \"已拆除\") {\r\n");
      ...
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("    function loadCcJson2(chart) {\r\n");
      out.write("        var series = chart.series;\r\n");
      out.write("        while (series.length > 0) {//移除原始数据\r\n");
      out.write("            series[0].remove(false);\r\n");
      out.write("        }\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url: 'getCcJson2',\r\n");
      out.write("            success: function (dataJson) {\r\n");
      out.write("                var data = dataJson;\r\n");
      ...
      out.write("        $.get(\"dataTable\",{type:'cc',myTime:new Date().getTime()},function(data){\r\n");
