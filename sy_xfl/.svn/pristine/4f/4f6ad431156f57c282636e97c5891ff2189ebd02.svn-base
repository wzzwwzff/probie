...
<div class="content">
    <form class="form-horizontal" id="inputForm" method="post" action="delSave?<tags:searchParams/>">
        ...
        <fieldset>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="fieldValue"><input id="addDate" type="text" class="form-date-time form-control datepicker dateISO"
                                                  name="addDate"
                                                  value="<fmt:formatDate value='${notFamily.addDate}' pattern='yyyy-MM-dd'/>"/></td>
                    <td class="fieldName">签约时间：</td>
                    <td class="fieldValue"><input id="qyDate" type="text" class="form-date-time form-control datepicker dateISO"
                                                  name="qyDate"
