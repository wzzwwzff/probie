...
<table width="9512.00" border="0" cellpadding="0" cellspacing="0" style='width:5707.20pt;border-collapse:collapse;table-layout:fixed;'>
    ...
    <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        <td class="xl66" height="41.67" width="9512.00" colspan="74" style='height:25.00pt;width:5707.20pt;border-right:none;border-bottom:none;' x:str><span style='mso-spacerun:yes;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>签约台账</td>
    </tr>
    <tr height="41.67" class="xl65" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        <td class="xl67" height="41.67" colspan="32" style='height:25.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>家庭信息</td>
    ...
    <tr height="60" class="xl65" style='height:36.00pt;mso-height-source:userset;mso-height-alt:720;'>
        ...
        <td class="xl67" x:str>签约时间</td>
        <td class="xl67" x:str>交房状态</td>
        <td class="xl67" x:str>交房顺序号</td>
        <td class="xl67" x:str>拆除状态</td>
        <td class="xl67" x:str>财务状态</td>
    ...
    <tr height="41.67" class="xl65" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        <c:if test="${statusItem.count eq 1}">
            ...
            <td class="xl68" rowspan="${size}" x:str><fmt:formatDate value="${family.qyDate}" pattern="yyyy年MM月dd日"/> </td>
            <td class="xl68" rowspan="${size}"><tags:dataDict  dataDict="交房状态" value="${family.jfState}"/><fmt:formatDate value="${family.jfDate}" pattern="yyyy年MM月dd日"/></td>
            <td class="xl68" rowspan="${size}"><fmt:formatNumber value="${family.jfNumber}" pattern="000"/> </td>
            <td class="xl68" rowspan="${size}"><tags:dataDict  dataDict="拆除状态" value="${family.ccState}"/><br/><fmt:formatDate value="${family.ccDate}" pattern="yyyy年MM月dd日"/></td>
            <td class="xl68" rowspan="${size}"><tags:dataDict  dataDict="结算状态" value="${family.jsState}"/><br/><fmt:formatDate value="${family.jsDate}" pattern="yyyy年MM月dd日"/></td>
