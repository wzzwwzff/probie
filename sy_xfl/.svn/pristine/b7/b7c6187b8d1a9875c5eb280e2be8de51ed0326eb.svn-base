        ...
        <form class="form-inline" role="form" id="search">
            <div class="form-group">
                <div class="input-group input-group-sm">
                    ...
                    <tags:searchDataDict className="form-control" name="able" fieldType="integer" dataDict="是否有效"/>
                </div>
                <div class="input-group input-group-sm">
...
<table class="table table-bordered table-hover table-striped">
    ...
    <c:forEach items="${pageInfo.result}" var="deskCatalog" varStatus="status">
        <tr>
            ...
            <td class="text-center"><tags:dataDict dataDict="是否有效" value="${deskCatalog.able}"/></td>
