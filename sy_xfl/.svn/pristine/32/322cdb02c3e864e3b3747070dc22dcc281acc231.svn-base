...
<div class="container-fluid">
    <div class="row" style="margin-top: 50px;">
        <div class="col-lg-12 text-center" style="font-size: 45px;font-weight: bold;margin-bottom: 10px;">顺义区马坡镇西丰乐村棚户区改造土地开发项目拆除情况公示</div>
    </div>
    <div class="row">
...
<script>
                ...
                pie: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function () {
                            ...
                            if (this.point.name == '已拆除') {
                                return "<center>" + "已拆除:" + this.y + "户<br/>比例:" + this.point.percentage.toFixed(2) + "%</center>";
                            }
                            if (this.point.name == '未拆除') {
                                return "<center>" + "未拆除:" + this.y + "户<br/>比例:" + this.point.percentage.toFixed(2) + "%</center>";
                            }
                        }
                    },
                    showInLegend: false
    ...
    function getData(){
        $.get("dataTable",{type:'cc',myTime:new Date().getTime()},function(data){
            $("#data").html(data);
        })
