...
<fieldset>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <%--<td class="fieldValue"><input size="10" type="text" class="form-control_short" name="confirmArea" value="${family.confirmArea}"/>㎡</td>--%>
            <td class="fieldName">合法宅基地范围内正式房屋建筑面积【㎡】：</td>
            <td class="fieldValue"><input size="10" type="text" class="form-control_short number" name="buildArea" value="${family.buildArea}"/></td>

        </tr>
        <tr>
            <td class="fieldName">合法宅基地外的房屋建筑面积【㎡】：</td>
            <td class="fieldValue"><input size="10" type="text" class="form-control_short number" name="outBuildArea" value="${family.outBuildArea}"/></td>
        </tr>
        </tbody>
    </table>
</fieldset>
