...
<div class="container-fluid">
    <div class="row" style="margin-top: 50px;">
        <div class="col-lg-12 text-center" style="font-size: 45px;font-weight: bold;margin-bottom: 10px;">顺义区马坡镇西丰乐村棚户区改造土地开发项目交房情况公示</div>
    </div>
    <div class="row">
...
<script>
                ...
                pie: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function () {
                            ...
                            if (this.point.name == '已交房') {
                                return "<center>" + "已交房:" + this.y + "户<br/>比例:" + this.point.percentage.toFixed(2) + "%</center>";
                            }
                            if (this.point.name == '未交房') {
                                return "<center>" + "未交房:" + this.y + "户<br/>比例:" + this.point.percentage.toFixed(2) + "%</center>";
                            }
                        }
                    },
                    showInLegend: false
    ...
    function getData(){
        $.get("dataTable",{type:'jf',myTime:new Date().getTime()},function(data){
            $("#data").html(data);
        })
