                ...
                <form id="search" class="form-search">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <tags:searchDataDict name="checkState" className="form-control" fieldType="integer"
                                                 dataDict="审核状态"/>
                        </div>
            ...
            <c:forEach items="${pageInfo.result}" var="family" varStatus="status">
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href='finalForm?familyId=${family.id}&<tags:searchParams></tags:searchParams>'
                           title="数据预审"><i class="fa fa-edit"></i>&nbsp;数据预审
                        </a>
                    </td>
                </tr>
            </c:forEach>
