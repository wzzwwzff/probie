...
<fieldset>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="text-left"><tags:dataDict  dataDict="拆除状态" value="${family.ccState}"/></td>
        </tr>
        <tr>
            <td class="active text-right">拆除日期</td>
            <td class="text-left"><fmt:formatDate  value="${family.ccDate}" pattern="yyyy-MM-dd" /></td>
        </tr>
        <tr>
            <td class="active text-right">拆除经办人</td>
            <td class="text-left">${family.ccPerson}</td>
        </tr>
        <tr>
            <td class="active text-right">备注</td>
            <td colspan="3">${family.ccMemo}</td>
        </tr>
        </tbody>
    </table>
</fieldset>
