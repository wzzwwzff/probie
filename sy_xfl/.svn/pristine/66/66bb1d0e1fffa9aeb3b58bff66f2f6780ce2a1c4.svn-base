...
public class Family {
    ...
    private Integer isLive;    // 是否公示 1：否 2.是
...
//    private BigDecimal dezxbzf;         // 定额装修补助费
    ...
    private BigDecimal fqAzArea;        //放弃安置面积
    private BigDecimal azMoney;      //货币安置补偿款
    private Integer firstXFNum;      //第一次选房顺序号
    private Integer secondXFNum;      //第二次选房顺序号
    private Integer thirdXFNum;      //第三次选房顺序号

    public BigDecimal getAzMoney() {
        return azMoney;
    }

    public void setAzMoney(BigDecimal azMoney) {
        this.azMoney = azMoney;
    }

    public BigDecimal getFqAzArea() {
        return fqAzArea;
    }

    public void setFqAzArea(BigDecimal fqAzArea) {
        this.fqAzArea = fqAzArea;
    }
    ...
    public Integer getFirstXFNum() {
        return firstXFNum;
    }

    public void setFirstXFNum(Integer firstXFNum) {
        this.firstXFNum = firstXFNum;
    }

    public Integer getSecondXFNum() {
        return secondXFNum;
    }

    public void setSecondXFNum(Integer secondXFNum) {
        this.secondXFNum = secondXFNum;
    }

    public Integer getThirdXFNum() {
        return thirdXFNum;
    }

    public void setThirdXFNum(Integer thirdXFNum) {
        this.thirdXFNum = thirdXFNum;
    }
