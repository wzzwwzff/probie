...
<html lang="en">
<head>
    <title>顺义区马坡镇西丰乐村棚户区改造土地开发项目交房情况公示</title>
...
<div class="container-fluid">
    <div class="row" style="margin-top: 15px;">
        <div id="titleHead" style="font-size: 12px;font-weight: bold;position:absolute; width: 100%;text-align: center;margin-bottom: 15px;">顺义区马坡镇西丰乐村棚户区改造土地开发项目交房情况公示</div>
    </div>
    <div class="row">
        <div>
...
<script>
    ...
    function getData(){
        $.get("dataTablePhone",{type:'jf',myTime:new Date().getTime()},function(data){
            $("#data").html(data);
        })
