                ...
                <form id="search" class="form-search">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <tags:searchDataDict name="ccState" className="form-control" fieldType="integer"
                                                 dataDict="拆除状态"/>
                        </div>
            ...
            <c:forEach items="${pageInfo.result}" var="family" varStatus="status">
                <tr>
                    ...
                    <td class="text-center">
                        <fmt:formatDate value="${family.ccDate}" pattern="yyyy-MM-dd"/>
                    </td>
                    <td class="text-center">
                        <a href='/cq/common/view/main?familyId=${family.id}'
                           title="查看"><i class="fa fa-eye"></i>&nbsp;查看
                        </a>&nbsp;&nbsp;
                        <a href='ccForm?familyId=${family.id}&<tags:searchParams></tags:searchParams>'
