...
<div class="content">
    <div class="search_content resizeLayout">
        <form class="form-inline" role="form" id="search">
            ...
            <button type="button" class="btn btn-sm btn-primary" onclick="location.href='wjfExcel?<tags:searchParams/>'"><i class="fa fa-forward"></i> 导出</button>
            </div>
        </form>
    </div>
...
<table class="table table-bordered table-hover table-striped">
    ...
    <tr>
        ...
        <%--<td class="text-center" colspan="11">家庭成员</td>--%>
