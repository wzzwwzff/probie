        ...
        <form class="form-inline" role="form" id="search">
            <div class="form-group">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <tags:searchDataDict className="form-control" name="jsState" fieldType="integer" dataDict="结算状态"  />
                </div>

            <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-search"></i> 查询</button>
            <button type="button" class="btn btn-sm btn-primary" onclick="location.href='signExcel?<tags:searchParams/>'"><i class="fa fa-forward"></i> 导出</button>
            </div>
        </form>
    </div>
...
<table class="table table-bordered table-hover table-striped">
    <thead>
    <tr>
        <td class="text-center" colspan="32">家庭信息</td>
    ...
    <tr>
        ...
        <th class="text-center" style="width: 130px;">签约时间</th>
        <th class="text-center" style="width: 130px;">交房状态</th>
        <th class="text-center" style="width: 100px;">交房顺序号</th>
        <th class="text-center" style="width: 130px;">拆除状态</th>
        <th class="text-center" style="width: 130px;">财务状态</th>
    ...
    <c:forEach items="${pageInfo.result}" var="family" varStatus="status">
        ...
        <tr>
            <c:if test="${statusItem.count eq 1}">
                ...
                <td class="text-center" rowspan="${size}"><fmt:formatDate value="${family.qyDate}" pattern="yyyy年MM月dd日"/> </td>
                <td class="text-center" rowspan="${size}"><tags:dataDict  dataDict="交房状态" value="${family.jfState}"/><br><fmt:formatDate value="${family.jfDate}" pattern="yyyy年MM月dd日"/></td>
                <td class="text-center" rowspan="${size}"><fmt:formatNumber value="${family.jfNumber}" pattern="000"/> </td>
                <td class="text-center" rowspan="${size}"><tags:dataDict  dataDict="拆除状态" value="${family.ccState}"/><br><fmt:formatDate value="${family.ccDate}" pattern="yyyy年MM月dd日"/></td>
                <td class="text-center" rowspan="${size}"><tags:dataDict  dataDict="结算状态" value="${family.jsState}"/><br><fmt:formatDate value="${family.jsDate}" pattern="yyyy年MM月dd日"/></td>
