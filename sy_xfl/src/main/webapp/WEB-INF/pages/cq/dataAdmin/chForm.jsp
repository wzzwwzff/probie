...
<body>
<div class="title"><h5>测绘信息修改</h5></div>
<form method="post" id="chForm" class="form-inline">
    <div class="content">
    ...
    <div class="footer2">
        <button class="btn btn-primary btn-sm" type="button" onclick="javascript:chSave()"><i class="fa fa-save"></i>&nbsp;保存</button>
        &nbsp;&nbsp;
