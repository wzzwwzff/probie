...
<head>
    ...
    <script>
        function printPDF() {
            $.get("setActionInfo",{familyId:'${familyId}',type:'rg',mtTime:new Date().getTime()},function(data){
                if (data.code == "0000") {
...
<div class="content">
    <div id="pdf" class="data_table_height_auto">
        <iframe id="printf" name="printf" src="printRg?familyId=${familyId}#toolbar=0" style="width: 100%;border: 0px;height: 100%"></iframe>
    </div>
</div>
</body>
</html>
