            ...
            <c:forEach items="${pageInfo.result}" var="family" varStatus="status">
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <c:if test="${family.cqState lt 2}">
                            <a href='schemeForm?familyId=${family.id}&<tags:searchParams/>'
                               title="修改"><i class="fa fa-edit"></i>&nbsp;修改
                            </a>&nbsp;&nbsp;
                        </c:if>

                        <a href='printFrame?familyId=${family.id}&<tags:searchParams/>'
                           title="打印匡算单"><i class="fa fa-print"></i>&nbsp;匡算单
                        </a>
                    </td>
                </tr>
            </c:forEach>
