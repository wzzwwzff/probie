...
<fieldset>
    ...
    <table class="table table-bordered">
        ...
        <tr class="confir">
            ...
            <td class="fieldValue"><span class="confirFree"><fmt:formatNumber  value="${family.tctyfFee+0.000001}"  pattern="##0"/></span></td>
        </tr>
        <tr class="confir">
    ...
    <table class="table table-bordered" id="personTable">
        ...
        <c:forEach items="${familyPersonList}" var="familyPerson"  varStatus="status">
            <tr >
                ...
                <td style="text-align: center;"><fmt:formatDate value="${familyPerson.qrDate}" pattern="yyyy年MM月dd日"/></td>
...
<fieldset>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="fieldValue">${family.fswFee}<%--<fmt:formatNumber  value="${family.fswFee+0.000001}"  pattern="##0"/>--%>&nbsp;&nbsp;
                是否包含未经审批房屋重置成新价：<tags:dataDict dataDict="是否" value="${family.isGiveup}"/></td>
            <td class="fieldName">装修补助费【元】：</td>
            <td class="fieldValue">${family.realZxbzFee}<%--<fmt:formatNumber  value="${family.realZxbzFee+0.000001}"  pattern="##0"/>--%></td>
        </tr>
        <tr>
            <td class="fieldName">分户补偿款【元】：</td>
            <td class="fieldValue">${family.fhbcfFee}<%--<fmt:formatNumber  value="${family.fhbcfFee+0.000001}"  pattern="##0"/>--%></td>
            <td class="fieldName">合法宅基地内空地奖【元】：</td>
            <td class="fieldValue">${family.ktjFee}<%--<fmt:formatNumber  value="${family.ktjFee+0.000001}"  pattern="##0"/>--%></td>
        </tr>
        <tr>
            <td class="fieldName">评估价款合计【元】：</td>
            <td class="fieldValue" colspan="3">${family.pgAllCount}<%--<fmt:formatNumber  value="${family.pgAllCount+0.000001}" pattern="##0"/>--%></td>
        </tr>
        </tbody>
    </table>
</fieldset>
<fieldset>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="fieldValue">${family.bjbzFee}<%--<fmt:formatNumber  value="${family.bjbzFee+0.000001}"  pattern="##0"/>--%></td>
            <td class="fieldName">安置房补助费【元】：</td>
            <td class="fieldValue">${family.azfbzFee}<%--<fmt:formatNumber  value="${family.azfbzFee+0.000001}"  pattern="##0"/>--%></td>
        </tr>
        <tr>
            <td class="fieldName">人员安置补助费【元】：</td>
            <td class="fieldValue">${family.rybzFee}<%--<fmt:formatNumber  value="${family.rybzFee+0.000001}"  pattern="##0"/>--%></td>
            <td class="fieldName">生活补助费【元】：</td>
            <td class="fieldValue">${family.shbzFee}<%--<fmt:formatNumber  value="${family.shbzFee+0.000001}"  pattern="##0"/>--%></td>
        </tr>
        <tr>
            <%--<td class="fieldName">停产停业补助费【元】：</td>--%>
            <%--<td class="fieldValue">${family.tctyfFee}&lt;%&ndash;<fmt:formatNumber  value="${family.tctyfFee+0.000001}"  pattern="##0"/>&ndash;%&gt;</td>--%>
            <td class="fieldName">移机费【元】：</td>
            <td class="fieldValue">${family.yjfSumFee}<%--<fmt:formatNumber  value="${family.yjfSumFee+0.000001}"  pattern="##0"/>--%></td>
            <td class="fieldName">提前搬家奖【元】：</td>
            <td class="fieldValue">${family.tqbjfFee}<%--<fmt:formatNumber  value="${family.tqbjfFee+0.000001}"  pattern="##0"/>--%></td>
            <%--<td class="fieldName">独生子女补助费【元】：</td>--%>
            <%--<td class="fieldValue">${family.onlyFee}&lt;%&ndash;<fmt:formatNumber  value="${family.onlyFee+0.000001}"  pattern="##0"/>&ndash;%&gt;</td>--%>
        </tr>
        <%--<tr>--%>
            <%--<td class="fieldName">住房困难补助费【元】：</td>--%>
            <%--<td class="fieldValue"><fmt:formatNumber  value="${family.zfknFee+0.000001}"  pattern="##0"/></td>--%>
            <%--<td class="fieldName">周转补助费【元】：</td>--%>
            <%--<td class="fieldValue">${family.lsazfFee}&lt;%&ndash;<fmt:formatNumber  value="${family.lsazfFee+0.000001}"  pattern="##0"/>&ndash;%&gt;</td>--%>
        <%--</tr>--%>
        <tr>
            <td class="fieldName">合法利用奖【元】：</td>
            <td class="fieldValue">${family.confirmFee}<%--<fmt:formatNumber  value="${family.confirmFee+0.000001}"  pattern="##0"/>--%></td>
            <td class="fieldName">其他【元】：</td>
            <td class="fieldValue">${family.otherfFee}<%--<fmt:formatNumber  value="${family.otherfFee+0.000001}"  pattern="##0"/>--%></td>
        </tr>
        <%--<tr>--%>
...
<fieldset   style="margin-bottom: 40px;">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td colspan="3" style="text-align: left;vertical-align: middle;">${family.bcSumTatal}<%--<fmt:formatNumber  value="${family.bcSumTatal+0.000001}"  pattern="##0"/>--%></td>
        </tr>
        </tbody>
    </table>
</fieldset>
