        ...
        <fieldset>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="fieldValue" <c:if test="${familyType != 2}">colspan="3"</c:if>>
                        ${family.residencePermitCode}
                    </td>
                    <c:if test="${familyType == 2}">
                ...
                <tr>
                    ...
                    <td class="fieldValue" <c:if test="${familyType != 4 && familyType != 5}">colspan="3"</c:if>>${family.registerCode}
                    </td>
                    <c:if test="${familyType == 4 || familyType == 5}">
                        <td class="fieldName">有效期限：</td>
                        <td class="fieldValue">
                            <div style="float: left;">
                                <fmt:formatDate value="${family.startDate}" pattern="yyyy-MM-dd"/>
