...
<div class="title">
    <h4 style="color: #0d88cc">持有效证家庭信息列表</h4>
</div>
<div class="content">
        <div class="search_content resizeLayout">
                <form class="form-inline" role="holdForm">
                    ...
                    <a href="holdForm" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i>登记持有效证家庭信息</a>
                    <a href="excelForm?familyType=2" class="btn btn-primary btn-sm"><i
                            class="fa fa-file-excel-o"></i> 导出家庭信息台账</a>&nbsp;&nbsp;
                    <a href="/cq/compareInfo/innerExcelIndex?familyType=2" class="btn btn-primary btn-sm"><i class="fa fa-file-excel-o"></i>批量导入数据</a>
            ...
            <tr>
                ...
                <td style="text-align: center;width: 20%">
                    <c:if test="${family.dataStatus < 2}">
                        ...
                        <a href="holdForm?familyId=${family.id}&<tags:searchParams></tags:searchParams>"><i class="fa fa-edit"></i>修改</a>&nbsp;&nbsp;
                        <a href="javaScript:deleteRow('delete?familyId=${family.id}')" style="color: #cc5965"  title="删除"><i class="fa fa-delicious"></i>&nbsp;删除</a>&nbsp;&nbsp;
                        <a href='checkHoldForm?familyId=${family.id}&<tags:searchParams></tags:searchParams>' style="color: #00B83F"
