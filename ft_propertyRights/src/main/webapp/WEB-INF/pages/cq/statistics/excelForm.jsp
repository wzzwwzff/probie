...
<table width="1290" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr height="56.67" style='height:34.00pt;mso-height-source:userset;mso-height-alt:680;'>
        <td class="xl67" height="56.67" width="1290" colspan="12"
    ...
    <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        ...
        <td class="xl70" x:str>合同编号</td>
        <td class="xl70" x:str>产权人</td>
        ...
        <td class="xl70" x:str>合同签订日期</td>
        <td class="xl70" x:str>产权比例</td>
        <td class="xl70" x:str>数据状态</td>
    ...
    <c:forEach items="${pageInfo.result}" var="contract" varStatus="status">
        ...
        <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
            ...
            <td class="xl70" x:str rowspan="${len}">${contract.contractCode}</td>
            <td class="xl70" x:str rowspan="${len}">${contract.name}</td>
            <td class="xl70" x:str rowspan="${len}">${contract.idCard}</td>
            <td class="xl70" x:str rowspan="${len}"><tags:dataDict dataDict="项目名称" value="${contract.family.projectName}"/></td>
            <td class="xl70" x:str rowspan="${len}">${contract.house.buildNum}</td>
            <td class="xl70" x:str rowspan="${len}">${contract.house.unitNum}</td>
            <td class="xl70" x:str rowspan="${len}">${contract.house.houseNum}</td>
            <td class="xl70" x:str rowspan="${len}">${contract.house.buildArea}</td>
            <td class="xl71" x:str rowspan="${len}"><fmt:formatDate value="${contract.signDate}" pattern="yyyy-MM-dd"/></td>
            <td class="xl70" x:str rowspan="${len}">${contract.propertyRight}</td>
            <td class="xl70" x:str rowspan="${len}"><tags:dataDict dataDict="合同数据状态" value="${contract.status}"/></td>
         </tr>
        <%--</c:forEach>--%>
    </c:forEach>
