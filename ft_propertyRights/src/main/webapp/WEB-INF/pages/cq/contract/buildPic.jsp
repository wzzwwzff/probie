...
<%
    ...
    int column = 0;
%>
<div style="text-align: center;width: 98%;margin-top: 15px;margin-left: 10px;margin-right: 20px" id="content">
...
//                     for (int j = maxSetNum - 1; j >= 0; j--) {
        ...
        <tr>
            <td bgcolor="#cccccc" height="35">
                <div class="out">
                    <span class="bm">单元</span>/<span class="em">楼层</span>
                </div>
            </td>
            <%
...
//                                str2 = dataDict.getAttributeName();
                            ...
                            if(house.getHouseType() != null&&!house.getHouseType().equals("")  ){
                                showInfo +="<br/><font style='font-size:20px;'>"+house.getHouseType()+"居室"+"</font>&nbsp;&nbsp;";
                                br="";
                            }
                            if (house.getStatus() == 1) {
                                showInfo += br+"<input op='"+StringUtils.getNotNullString(house.getMemo())+"' style='cursor: pointer;' type='radio' title='"
