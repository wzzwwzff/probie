...
<body>
<div class="title">
    <h4 style="color: #0d88cc">合同信息核验</h4>
</div>
<div class="content">
    <fieldset>
            ...
            <div class="text-center">
                <button type="button" class="btn btn-primary" onclick="javascript:handUp('${contract.id}')"><i
...
<script>
    ...
    function handUp(contractId){
        if(confirm("确定上报吗")){
            $.get("reportData", {contractId: contractId}, function (data) {
                if (data.code == "1111") {
                    alert("上报成功");
                    location.href="list";
                } else {
