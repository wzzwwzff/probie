...
<body>
<div id="title" style="font-size: 20px;">家庭成员信息批量导入</div>

<form name="form" id="form" action="comparison2" method="post" enctype="multipart/form-data">
    ...
    <input name="sumbit" id="sumbit" type="button" value="信息导入" onclick="tosumbit();"/>
    </span>
