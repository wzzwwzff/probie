...
<table width="1290" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr height="56.67" style='height:34.00pt;mso-height-source:userset;mso-height-alt:680;'>
        <td class="xl67" height="56.67" width="1290" colspan="18"
    ...
    <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        ...
        <td class="xl70" x:str>产权人姓名</td>
        <td class="xl70" x:str>产权人身份证号</td>
        <td class="xl70" x:str>分配后租房人/转售人姓名</td>
        <td class="xl70" x:str>分配后租房人/转售人身份证号</td>
        <td class="xl70" x:str>分配后出租日期/转售日期/回购日期</td>
    ...
    <c:forEach items="${pageInfo.result}" var="house" varStatus="status">
        ...
        <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
            ...
            <td class="xl70" x:str rowspan="${len}">${house.name}</td>
            <td class="xl70" x:str rowspan="${len}">${house.idCard}</td>
            <td class="xl70" x:str rowspan="${len}">${house.rentName}</td>
            <td class="xl70" x:str rowspan="${len}">${house.rentIdCard}</td>
            <td class="xl71" x:str rowspan="${len}"><fmt:formatDate value="${contract.rentDate}" pattern="yyyy-MM-dd"/></td>
