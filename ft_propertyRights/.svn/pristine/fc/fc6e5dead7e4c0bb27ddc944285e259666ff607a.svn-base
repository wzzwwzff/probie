...
<head>
    ...
    <title>5年及以上缴纳个税家庭信息</title>
    <%@include file="/static/common/common.jsp" %>
</head>
<body>
<div class="title">
    <h4 style="color: #0d88cc">5年及以上缴纳个税家庭信息</h4>
</div>
<div class="content">
    <form class="form-horizontal" id="form" name="myForm" action="personalSave?familyId=${family.id}&<tags:searchParams></tags:searchParams>" method="post">
        <input type="hidden" value="${family.id}" />
        <input type="hidden" value="5" name="familyType" />
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue">
                            ...
                            <div style="float: right;margin-right:200px;"><input type="text" name="exIdCard" value="${family.exIdCard}"class="form-control"style="width: 10em"></div>
                        </td>
                    </tr>
                    <tr>
