...
<head>
    ...
    <title>5年及以上缴纳社保家庭信息</title>
    <%@include file="/static/common/common.jsp" %>
</head>
<body>
<div class="title">
    <h4 style="color: #0d88cc">登记5年及以上缴纳社保家庭信息</h4>
</div>
<div class="content">
    <form class="form-horizontal" id="form" name="myForm" action="socialSave?familyId=${family.id}&<tags:searchParams></tags:searchParams>" method="post">
        <input type="hidden" value="${family.id}" />
        <input type="hidden" value="4" name="familyType" />
            ...
            <fieldset>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue">
                            <div style="float: left">
                                <tags:dataDictInput name="workUnit" value="${family.workUnit}" firstValue="--请选择--" className="form-control" dataDict="工作地（社保缴纳地）"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
