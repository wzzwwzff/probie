...
<div class="loginPageBody">
    <div class="loginWrapbg">
        ...
        <div style="margin-left: 260px;">
            <div class="row" style="margin-top: 60px;font-size: 40px;color: #0B61A4;">
                <img src="/static/image/logo.jpg" style="margin-top: -10px">
                <span style="line-height:70px;font-size: 38px;padding-top:20px;margin-top: 15px;font-family:'微软雅黑','黑体' "><b><%=systemName %>
                </b></span>
            </div>
            <div class="carousel slide col-lg-7" id="myCarousel" data-ride="carousel"
                 style="padding-left: 0;padding-right: 10px;">

                <div class="carousel-inner">
                    <div class="item active">
                        <img date-src="images/pic1.jpg" src="/static/image/login/1.jpg" alt="First slide [1500x954]"
                             date-hoder-rendered="true"/>
                    </div>
                    <div class="item">
                        <img date-src="images/pic2.jpg" src="/static/image/login/3.jpg" alt="First slide [1500x954]"
                             date-hoder-rendered="true"/>
                    </div>
                    <div class=" item">
                        <img date-src="images/pic3.jpg" src="/static/image/login/2.jpg" alt="First slide [1500x954]"
                             date-hoder-rendered="true"/>
                    </div>
                </div>
            </div>
            <!--轮播图-->
            <div class="col-lg-4" style="padding: 16px 16px 44px;border: solid 1px lightgrey;height: 610px;width: auto;">
                <div class="welcome" style="margin-top: 40px;"><span id="logining_info">请输入用户名、密码、验证码</span></div>
                <div class="loginBar" id="loginBar">
                    <form name="submitForm" id="submitForm">
                        ...
                        <div class="" style="text-align: center;margin-top: 40px;">
                            ...
                            <div class="fieldWrap" style="margin-top: 40px;">
                            ...
                            <div class="fieldWrap" style="margin-top: 40px;">
                                ...
                                &nbsp;<a href="javascript:reloadCode();"><img id="licenceImg"
                                                                              src="/servlet/validateCodeServlet"
                                                                              alt='验证码,看不清楚? 请点击刷新验证码'></a>
                            </div>
                            <%}%>
                            <div class="loginBtnWrap" onclick="checkLogin();" style="margin-top: 40px;">登 录</div>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <div class="footer navbar-fixed-bottom" style="text-align: center;padding-bottom: 50px;color:#0B61A4;">
            <%if (keyUsed) {%>
