...
<body>
<div class="title">
    <h4 style="color: #0d88cc">资格复核修改</h4>
</div>
<div class="content">
    <form class="form-horizontal" id="form" name="myForm" action="saveCheckStatus?familyId=${family.id}&<tags:searchParams></tags:searchParams>" method="post">
        ...
        <div class=" doc-content"
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue">
                            ...
                            <div style="float: left;margin-left:20px;"><input type="text" name="idCard" value="${family.idCard}" placeholder="必填项"
                    ...
                    <tr>
                        ...
                        <td class="fieldValue">
                            <input type="text" name="registerCode" value="${family.registerCode}" class="form-control" style="width: 15em"/>
                        </td>
            ...
            <fieldset>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue"><div style="float: left"><tags:dataDictInput dataDict="是否" name="continuity" value="${family.continuity}" className="form-control" /></div>
                        </td>
                    </tr>
                    <tr>
            ...
            <fieldset>
                <legend>六、复核状态</legend>
                <table class="table table-bordered">
                    <tbody>
                    <tr>
                        <td class="fieldName">住房审核状态：</td>
                        <td class="fieldValue"><tags:dataDictRadio dataDict="审核状态" value="${family.houseStatus}" name="houseStatus" /></td>
                        <td class="fieldName">社保审核状态：</td>
                        <td class="fieldValue"><tags:dataDictRadio dataDict="审核状态" value="${family.socialStatus}" name="socialStatus" />
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldName">婚姻审核状态：</td>
                        <td class="fieldValue"><tags:dataDictRadio dataDict="审核状态" value="${family.marriageStatus}" name="marriageStatus" /></td>
                        <td class="fieldName">年龄审核状态：</td>
                        <td class="fieldValue"><tags:dataDictRadio dataDict="审核状态" value="${family.ageStatus}" name="ageStatus" />
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldName">学历审核状态：</td>
                        <td class="fieldValue"><tags:dataDictRadio dataDict="审核状态" value="${family.educationStatus}" name="educationStatus" /></td>
                        <td class="fieldName">其他审核状态：</td>
                        <td class="fieldValue"><tags:dataDictRadio dataDict="审核状态" value="${family.otherStatus}" name="otherStatus" />
                        </td>
                    </tr>
                    </tbody>
                </table>
