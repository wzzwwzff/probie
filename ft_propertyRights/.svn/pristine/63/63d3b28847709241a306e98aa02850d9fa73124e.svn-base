...
<div class="content">
    <form class="form-horizontal" id="inputForm" method="post" action="save?<tags:searchParams/>">
        ...
        <input type="hidden" name="houseId" id="houseId" value="${contract.house.id}"/>
        <input type="hidden" name="projectName" class="projectName" value="${family.projectName}"/>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="fieldValue">
                    <input type="text" name="familyCode" class="form-control required" style="width: 10em" size="10"
                           value="${contract.familyCode eq null ? family.familyCode :contract.familyCode}"/>
                </td>
            ...
            <tr>
                ...
                <td class="fieldValue">
                        <tags:dataDict dataDict="项目名称" value="${family.projectName}"/>
                </td>
                ...
                <td class="fieldValue">
                    ...
                    <select class="form-control" style="width: 10em" id="xf" name="buildNum">
                        <c:forEach items="${buildNums}" var="buildNum">
                            <option <c:if test="${contract.house.buildNum == buildNum}">selected</c:if>>${buildNum}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="fieldValue">
                    <input type="text" name="person" class="form-control" style="width: 10em" size="10"
                           value="${(contract.person eq '' || contract.person eq null)? person:contract.person}"/>
                </td>
            </tr>
            <tr>
