...
<div class="title">
    <h4>房源列表<span style="color: red">【项目:${project.projectName}】</span></h4>
</div>
<div class="content">
    <div class=" doc-contentInfo">
        <div class="search">
            <form class="form-inline" action="houseList">
                ...
                <a href="excelForm?projectId=${projectId}" class="btn btn-primary btn-sm"><i class="fa fa-file-excel-o"></i>
                    导出房源信息
                </a>&nbsp;
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th style="text-align: center;">房源状态</th>
