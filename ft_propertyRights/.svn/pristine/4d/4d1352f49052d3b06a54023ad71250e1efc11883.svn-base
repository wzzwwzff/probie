        ...
        <form class="form-inline" role="form" id="search">
            <div class="form-group">
                <div class="input-group input-group-sm">
                    ...
                    <tags:searchInput name="c.contractCode" className="form-control" fieldType="string"
                                      operator="like"/>
                </div>
                <div class="input-group input-group-sm">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <tags:searchDataDict name="c.status" className="form-control" fieldType="integer"
                                         dataDict="合同数据状态"/>
                </div>
            </div>
        ...
        <c:forEach items="${pageInfo.result}" var="contract" varStatus="status">
            <tr>
                ...
                <td class="text-center">
                    <a href='contractUploadList?contractId=${contract.id}'><i class='fa fa-hand-o-up'></i>上传档案资料</a>
                </td>
            </tr>
        </c:forEach>
    </table>
