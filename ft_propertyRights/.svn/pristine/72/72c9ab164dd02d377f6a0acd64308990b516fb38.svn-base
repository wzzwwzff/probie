...
<head>
    ...
    <title>本市户籍家庭信息</title>
    <%@include file="/static/common/common.jsp" %>
</head>
<body>
<div class="title">
    <h4 style="color: #0d88cc">本市户籍家庭信息</h4>
</div>
<div class="content">
    <form class="form-horizontal" id="form" name="myForm" action="save?familyId=${family.id}&<tags:searchParams></tags:searchParams>" method="post">
        ...
        <input type="hidden" value="1" name="familyType" />
        ...
        <fieldset>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="fieldValue">
                        <div style="float: left;">
                            <tags:dataDictInput name="cardType" className="form-control" value="${family.cardType}" firstValue="--请选择--" dataDict="证件类型"/>
                        </div>
                ...
                <tr>
                    ...
                    <td class="fieldValue">
                        <div style="float: left;">
                            <tags:dataDictInput name="marryStatus" className="form-control" value="${family.marryStatus}" firstValue="--请选择--" dataDict="婚姻状况"/>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="fieldValue">
                        <div style="float: left">
                            <tags:dataDictInput name="workUnit" className="form-control" value="${family.workUnit}" firstValue="--请选择--" dataDict="工作地（社保缴纳地）"/>
                        </div>
                    </td>
        ...
        <fieldset>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="fieldValue">
                        <div style="float: left;">
                            <tags:dataDictInput name="exCardType" className="form-control" value="${family.exCardType}" firstValue="--请选择--" dataDict="证件类型"/>
                        </div>
            ...
            <table class="table table-bordered" id="personTable" style="margin-top: -5px;">
                ...
                <c:forEach begin="0" end="${fn:length(familyPersonList)}" var="i" varStatus="status">
                    <tr>
                        ...
                        <td align="center">
                            <input type="text" name="fp_name" value="${familyPersonList[i].name}" size="10" class="form-control personName"/>
                        </td>
                        <td align="center">
                                <tags:dataDictInput name="fp_cardType" className="form-control" value="${familyPersonList[i].cardType}" firstValue="--请选择--" dataDict="证件类型"/>
                        </td>
                        <td align="center">
                            <input type="text" name="fp_idCard" value="${familyPersonList[i].idCard}" class="form-control">
                        </td>
                        <td align="center">
                                <tags:dataDictInput name="fp_relationShip" className="form-control" value="${familyPersonList[i].relationShip}" firstValue="--请选择--" dataDict="家庭成员关系"/>
                        </td>
