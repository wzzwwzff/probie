...
<table width="328" border="0" cellpadding="0" cellspacing="0" style='width:196.80pt;border-collapse:collapse;table-layout:fixed;'>
    <tr height="58.33" style='height:35.00pt;mso-height-source:userset;mso-height-alt:700;'>
        <c:if test="${familyPerson eq 'familyPerson'}">
            <td class="xl65" height="58.33" width="704" colspan="${fn:length(theads)+5}" style='height:35.00pt;width:422.40pt;border-right:none;border-bottom:none;' x:str>${title}</td>
        </c:if>
    ...
    <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
        ...
        <c:forEach items="${theads}" var="item" varStatus="status">
            ...
            <c:if test="${item eq '家庭成员'}">
                ...
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>证件类型</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>证件号码</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>关系</td>
                <td class="xl67" width="123.00" style='width:73.80pt;' x:str>户籍</td>
            </c:if>
        </c:forEach>
    </tr>
    <c:if test="${familyPerson eq 'familyPerson'}">
        <c:forEach items="${dataList}" var="data" varStatus="status">
            ...
            <c:forEach var="familyPerson" items="${familyPersonList}" varStatus="fpStatus">
                <tr height="41.67" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
                    ...
                    <td class="xl69"><tags:dataDict dataDict="证件类型" value="${familyPerson.cardType}"/></td>
                    <td class="xl69">${familyPerson.idCard}</td>
                    <td class="xl69"><tags:dataDict dataDict="家庭成员关系" value="${familyPerson.relationShip}"/></td>
