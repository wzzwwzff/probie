...
<head>
    ...
    <title>驻京现役军人或武警家庭信息</title>
    <%@include file="/static/common/common.jsp" %>
</head>
<body>
<div class="title">
    <h4 style="color: #0d88cc">驻京现役军人或武警家庭信息</h4>
</div>
<div class="content">
    <form class="form-horizontal" id="form" name="myForm" action="armySave?familyId=${family.id}&<tags:searchParams></tags:searchParams>" method="post">
        <input type="hidden" value="${family.id}" />
        <input type="hidden" value="3" name="familyType" />
            ...
            <fieldset>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue">
                            <div style="float: left;">
                                <tags:dataDictInput name="armyType" className="form-control" value="${family.armyType}" firstValue="--请选择--" dataDict="军官（警官）证件"/>
                            </div>
                        </td>
                        <td class="fieldName">证件号码：</td>
                        <td class="fieldValue">
                            <input type="text" name="armyIdCard" value="${family.armyIdCard}" class="form-control" style="width: 18em"/>
                        </td>
                    </tr>
                    <tr>
            ...
            <fieldset>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" colspan="3"><input type="text" value="${family.count}" id="count" readonly class="form-control"
                                                                  style="width: 5em"/></td>
                    </tr>
                    </tbody>
                </table>
