...
<%
    ...
    List<FileInfo> fileInfoListBack = (List<FileInfo>) request.getAttribute("fileInfoListBack");
...
<div class="widget">
    <div class="heading" style="width: 100%;margin-top: 15px;margin-bottom: 5px;margin-left: 5px">
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade active" id="profile">
                <div class="docs-galley">
                    ...
                    <ul class="docs-pictures clearfix">
                        <%
                            for (FileInfo fileInfo : fileInfoListBack) {
                                if (fileInfo.getDelStatus() == 1) {
                                    continue;
                                }
                                String filePath = StringUtils.getNotNullString(fileInfo.getFilePath());
