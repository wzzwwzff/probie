        ...
        <form class="form-inline" role="form" id="search">
            <div class="form-group">
                <div class="input-group input-group-sm">
                    <div class="input-group-addon">申诉人姓名</div>
                ...
                <div class="input-group input-group-sm">
                    <div class="input-group-addon">申诉日期</div>
                ...
                <button type="button" class="btn btn-sm btn-primary" onclick="location.href='form';">
                    <i class="glyphicon glyphicon-plus"></i>登记申诉信息
                </button>
            </div>
        </form>
    </div>
        ...
        <c:forEach items="${pageInfo.result}" var="complain" varStatus="status">
            <tr>
                ...
                <td class="text-center">
                    <a href='form?complainId=${complain.id}&<tags:searchParams></tags:searchParams>' title="修改"><i
