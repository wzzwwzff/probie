...
<div class="content">
    <ul class="nav nav-tabs">
        <li>
            <a href="saleHouse">转售信息登记</a>
        </li>
        <li class="active">
            <a href="saleList">转售信息列表</a>
        </li>
    </ul>
    <div class="search_content resizeLayout" style="margin-top: 5px;">
        <form class="form-inline" role="form" id="search">
            <div class="form-group">
                ...
                <div class="input-group input-group-sm">
                    <div class="input-group-addon">转售人姓名</div>
                    <tags:searchInput name="rentName" className="form-control" fieldType="string" operator="like"/>
                </div>
                <div class="input-group input-group-sm">
                    <div class="input-group-addon">转售人身份证号</div>
                    <tags:searchInput name="rentIdCard" className="form-control" fieldType="string" operator="like"/>
                </div>
                <div class="input-group input-group-sm">
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <c:if test="${contract.status ne 3}">
                        <a href="turnSaleForm?houseId=${house.id}"><i class="fa fa-edit"></i>修改转售人信息</a>&nbsp;&nbsp;
                    </c:if>
                </td>
            </tr>
        </c:forEach>
