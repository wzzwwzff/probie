...
<body>
<div class="title">
    <h4 id="installing" >项目资料列表&nbsp;【项目名称：${project.projectName}】</h4>
</div>
<div class="content">
        <div style="float:right">
            <a href="setUpPaper?projectId=${project.id}"  data-width="45%" class="btn btn-info btn-sm myModal"><i class="fa fa fa-plus-square"></i> 创建文件夹</a>
            <button class="btn btn-primary btn-sm" type="button" onclick="window.location.href='list'"><i class="fa fa-backward"></i>&nbsp;返回列表</button>
        </div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="text-center"><img style="width: 20px;margin-left: 0px;" src="/static/image/file.png" /><a href="projectRight?fileid=${proFile.id}">${proFile.fileName}</a></td>
                ...
                <td class="text-center">
                    <a href='setUpPaper?proFileId=${proFile.id}&projectId=${project.id}'><i class='a fa-big fa-edit'></i>修改</a>
...
<script>
    ...
    function deleteData(fileId) {
        if (confirm("确定删除？")) {
            $.get("deleteData", {fileId: fileId}, function (data) {
