...
<body>
<div id="title" style="font-size: 20px;">房源信息批量导入</div>

<form id="form" action="plHouseSave" method="post" enctype="multipart/form-data">
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td><div align="left" style="font-size:14pt;font-family:宋体; line-height:30px; color:#000000;">1、数据导入格式要求：<br />
                ...
                &nbsp;&nbsp;&nbsp;c.Excel表第一行为标题。<br/>
                &nbsp;&nbsp;&nbsp;d.数据导入格式<a href="/static/房源信息模板.xls">Excel模板下载</a>。</div></td>
            <td>&nbsp;</td>
        </tr>
    ...
    <input name="sumbit" id="sumbit" type="button" value="房源信息导入" onclick="tosumbit();"/>
    </span>
